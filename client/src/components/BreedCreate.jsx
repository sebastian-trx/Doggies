...
export function BreedCreate(){
    ...
    return(
        <div>
            <Link to="/home"><button>Ir a pagina principal</button></Link>
            ...
            <form onSubmit = {handleSubmit}>
                ...
                <div>
                    ...
                    <ul>
                            ...
                            {
                            input.temperament &&
                            input.temperament.map(el => <li>{el+', '} <button type= 'button' onClick={(e) => {handleClick(e,el)}}>x</button></li>)
                            }
